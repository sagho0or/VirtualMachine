...
public class SvmRuntimeException: Exception
{
    ...
    public SvmRuntimeException(string message) : base($"{msg} Message: {message}") { }
    public SvmRuntimeException(string message, Exception innerException) : base($"{msg} Message: {message}", innerException) { }
