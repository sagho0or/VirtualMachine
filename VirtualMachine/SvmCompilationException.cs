...
public class SvmCompilationException :Exception
{
    ...
    public SvmCompilationException(string message) : base($"{msg} Message: {message}") { }
    public SvmCompilationException(string message, Exception innerException) : base($"{msg} Message: {message}", innerException) { }
